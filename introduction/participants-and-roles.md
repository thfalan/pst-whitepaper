...
* **Merchants:** Each Royalty Token represents a portfolio of e‑shops. Merchants remain in control of their day‑to‑day operations and generate revenue; however, they typically commit to a [**Performance-Linked Stake**](<../README (2).md#performance-linked-stake>) as collateral (size is set per listing; figures such as “15% of market cap” elsewhere are **illustrative only**). This stake is gradually unlocked as revenue performance targets are met, ensuring that merchants remain aligned with investor interests.
